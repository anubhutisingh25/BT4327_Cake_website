                    	...
                    	<div class="card">
                    		<div class="card-body">
                    			<div class="text-secondary font-italic m-3">
                                    <p>
                                        Welcome to Slice & Share, where every moment is a celebration! At Slice & Share, we believe that life is better with a slice of cake.
                                    </p>
                                    <p>
                                        At Slice & Share, we believe that every occasion is sweeter with a slice of happiness. Our journey began with a simple goal: to create delicious and visually stunning cakes that bring people together. 
                                    </p>
                                    <p>
                                        From classic flavors to innovative designs, Slice & Share is your go-to destination for the perfect centerpiece that not only tantalizes the taste buds but also sparks joy and creates lasting memories. 
                                    </p>
                                    <p>
                                        Join us in the celebration of life's sweetest moments, one slice at a time!
                                    </p>
                                    <p>
                                    Cheers to one year of slicing and sharing joy!
                                    </p>
                                    <p>
                                        SLICE & SHARE
                                    </p>
